...
import com.gl4a.R;
import com.gl4a.fragment.CollaboratorListFragment;

/**
 * Lists members (collaborators) of a GitLab project.
 * Uses {@link com.gl4a.gitlab.service.GitLabProjectService#getMembers} to retrieve the list.
 */
public class CollaboratorListActivity extends FragmentContainerActivity {
    ...
    protected Fragment onCreateFragment() {
        return CollaboratorListFragment.newInstance(mRepoOwner, mRepoName);
    }

...
import com.gl4a.R;
import com.gl4a.fragment.WatcherListFragment;

/**
 * Shows project members for a GitLab project.
 * GitLab has no separate "watchers" concept; project members are displayed instead.
 */
public class WatcherListActivity extends FragmentContainerActivity {
    ...
    protected String getActionBarTitle() {
        return getString(R.string.repo_watchers);
    }

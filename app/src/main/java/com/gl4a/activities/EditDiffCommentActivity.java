...
/** Edit or create a diff comment on a commit. TODO: Implement via GitLab commit note API. */
public class EditDiffCommentActivity extends EditCommentActivity {
    ...
    protected Single<GitLabComment> createComment(String repoOwner, String repoName,
        ...
        return Single.error(new UnsupportedOperationException("Commit diff comment creation not yet implemented for GitLab"));
    }

    @Override
    protected Single<GitLabComment> editComment(String repoOwner, String repoName,
            long commentId, String body) {
        return Single.error(new UnsupportedOperationException("Commit diff comment edit not yet implemented for GitLab"));
    }
}

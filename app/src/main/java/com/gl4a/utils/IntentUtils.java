...
public class IntentUtils {
    ...
    public static Uri.Builder createBaseUriForUser(String user) {
        String host = android.net.Uri.parse(com.gl4a.Gl4Application.get().getInstanceUrl()).getHost();
        return new Uri.Builder()
                .scheme("https")
                .authority(host != null ? host : "gitlab.com")
                .appendPath(user);
    }
    ...
    public static String createRawFileUrl(String repoOwner, String repoName, String ref, String path) {
        // GitLab raw file URL: <instance>/<owner>/<repo>/-/raw/<ref>/<path>
        String instanceUrl = com.gl4a.Gl4Application.get().getInstanceUrl();
        return instanceUrl + "/" + repoOwner + "/" + repoName + "/-/raw/" + ref + "/" + path;
    }

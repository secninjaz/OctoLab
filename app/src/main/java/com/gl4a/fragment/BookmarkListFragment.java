...
import com.gl4a.R;
import com.gl4a.adapter.BookmarkAdapter;
...
public class BookmarkListFragment extends LoadingListFragmentBase implements
    ...
    public static class BookmarkDragHelperCallback extends ItemTouchHelper.SimpleCallback {
        ...
        public boolean onMove(RecyclerView recyclerView, RecyclerView.ViewHolder viewHolder,
            ...
            // Fix: must return true to confirm the move was handled, otherwise
            // ItemTouchHelper discards the drag animation and snaps items back.
            return true;
        }

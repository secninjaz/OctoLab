...
public class RepositoryListContainerFragment extends Fragment implements
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        mMainFragment = (PagedDataBaseFragment<GitLabProject>) fm.findFragmentByTag("main");
    ...
    private void validateSortOrder() {
        if (TextUtils.equals(mFilterType, "starred")) {
            if (!TextUtils.equals(mSortOrder, "updated")
                    && !TextUtils.equals(mSortOrder, "created_at")) {
                mSortOrder = "created_at";
                mSortDirection = "desc";
            }
        } else {
    ...
    public static class FilterDrawerHelper {
        ...
        public static FilterDrawerHelper create(String userLogin, boolean isOrg) {
            int menuResId;
            if (ApiHelpers.loginEquals(userLogin, Gl4Application.get().getAuthLogin())) {
    ...
    public static class SortDrawerHelper {
        ...
        static {
            SORT_LOOKUP.put(R.id.sort_name_asc, new String[] { "name", "asc" });
            SORT_LOOKUP.put(R.id.sort_name_desc, new String[] { "name", "desc" });
            ...
            SORT_LOOKUP.put(R.id.sort_pushed_asc, new String[] { "last_activity_at", "asc" });
            SORT_LOOKUP.put(R.id.sort_pushed_desc, new String[] { "last_activity_at", "desc" });

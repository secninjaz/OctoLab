...
import com.gl4a.gitlab.model.GitLabMergeableState;
...
import com.gl4a.R;
import com.gl4a.model.StatusWrapper;
...
public class CommitStatusBox extends LinearLayoutCompat implements View.OnClickListener {
    ...
    public void fillStatus(List<StatusWrapper> statuses, GitLabMergeableState mergableState) {
        ...
        if (mergableState == GitLabMergeableState.Unstable && pendingCount > 0) {

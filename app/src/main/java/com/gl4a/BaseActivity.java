...
import com.gl4a.widget.ToggleableAppBarLayoutBehavior;
...
public abstract class BaseActivity extends AppCompatActivity implements
                ...
                if (result.getResultCode() == Activity.RESULT_OK) {
                    Snackbar.make(mCoordinatorLayout, R.string.issue_reported, Snackbar.LENGTH_LONG)
                            .setAction(R.string.view, v -> {
                                GitLabIssue createdIssue = result.getData().getParcelableExtra("issue");
                                Intent intent = IssueActivity.makeIntent(this, createdIssue, -1L);
    ...
    private void handleFailure(String text, Throwable e) {
        ...
        if (isAuthError) {
            Snackbar.make(mCoordinatorLayout, R.string.load_auth_failure_notice, Snackbar.LENGTH_INDEFINITE)
                    ...
                    .show();
            Log.d(Gl4Application.LOG_TAG, text, e);
            return;
        }
        ...
        Log.e(Gl4Application.LOG_TAG, text, e);
    }
    ...
    protected Intent getToplevelActivityIntent() {
        ...
        if (app.isAuthorized()) {
            ...
            return new Intent(this, GitLabLoginActivity.class);
        }
    }
    ...
    private void launchIssueCreationForError(Throwable e) {
        // Copy the error details to clipboard so the user can paste them into
        // any issue tracker — GitLab, GitHub, or elsewhere.
        // Hardcoding an instance URL is not appropriate for a public app where
        // different deployments use different trackers.
        ...
        if (clipboard != null) {
            clipboard.setPrimaryClip(
                    android.content.ClipData.newPlainText("OctoLab error", issueBody));
            android.widget.Toast.makeText(this,
                    R.string.error_copied_to_clipboard, android.widget.Toast.LENGTH_LONG).show();
        }
    }
